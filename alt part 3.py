...
class DTA:
    ...
    def perform_timing_attack(self, pub_e, pub_n, oracle):
        """
        Timing attack
        ...
        for i in range(1, 63):
            ...
            if abs(np.corrcoef(self.reader.timings, extra_reductions_0)[0, 1]) < abs(
                    np.corrcoef(self.reader.timings, extra_reductions_1)[0, 1]):
                d = d_1
